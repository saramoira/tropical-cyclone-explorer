...
def ColorizedIR():
	...
	color_map = np.array([[3,3,3],[4,4,4],[6,6,6],[7,7,7],[8,8,8],[9,9,9],[11,11,11],
		[12,12,12],[13,13,13],[14,14,14],[16,16,16],[17,17,17],[18,18,18],[20,20,20],
		[21,21,21],[22,22,22],[23,23,23],[25,25,25],[26,26,26],[27,27,27],[29,29,29],
		[30,30,30],[31,31,31],[32,32,32],[34,34,34],[35,35,35],[36,36,36],[37,37,37],
		[39,39,39],[40,40,40],[41,41,41],[43,43,43],[44,44,44],[45,45,45],[46,46,46],
		[48,48,48],[49,49,49],[50,50,50],[52,52,52],[53,53,53],[54,54,54],[55,55,55],
		[57,57,57],[58,58,58],[59,59,59],[60,60,60],[62,62,62],[63,63,63],[64,64,64],
		[66,66,66],[67,67,67],[68,68,68],[69,69,69],[71,71,71],[72,72,72],[73,73,73],
		[74,74,74],[76,76,76],[77,77,77],[78,78,78],[80,80,80],[81,81,81],[82,82,82],
		[83,83,83],[85,85,85],[86,86,86],[87,87,87],[89,89,89],[90,90,90],[91,91,91],
		[92,92,92],[94,94,94],[95,95,95],[96,96,96],[97,97,97],[99,99,99],[100,100,100],
		[101,101,101],[103,103,103],[104,104,104],[105,105,105],[106,106,106],[108,108,108],
		[109,109,109],[110,110,110],[111,111,111],[113,113,113],[114,114,114],[115,115,115],
		[117,117,117],[118,118,118],[119,119,119],[120,120,120],[122,122,122],[123,123,123],
		[124,124,124],[126,126,126],[127,127,127],[128,128,128],[129,129,129],[131,131,131],
		[132,132,132],[133,133,133],[134,134,134],[136,136,136],[137,137,137],[138,138,138],
		[140,140,140],[141,141,141],[142,142,142],[143,143,143],[145,145,145],[146,146,146],
		[147,147,147],[149,149,149],[150,150,150],[151,151,151],[152,152,152],[154,154,154],
		[155,155,155],[156,156,156],[157,157,157],[159,159,159],[160,160,160],[161,161,161],
		[163,163,163],[164,164,164],[165,165,165],[166,166,166],[168,168,168],[169,169,169],
		[170,170,170],[171,171,171],[173,173,173],[174,174,174],[175,175,175],[177,177,177],
		[178,178,178],[179,179,179],[180,180,180],[182,182,182],[183,183,183],[184,184,184],
		[186,186,186],[187,187,187],[188,188,188],[189,189,189],[191,191,191],[192,192,192],
		[193,193,193],[194,194,194],[196,196,196],[197,197,197],[0,255,255],[0,242,248],
		[0,230,241],[0,217,234],[0,204,227],[0,191,220],[0,179,213],[0,166,206],[0,153,199],
		[0,140,192],[0,128,185],[0,115,178],[0,102,171],[0,89,164],[0,77,157],[0,64,150],
		[0,51,143],[0,38,136],[0,26,129],[0,13,122],[0,0,115],[0,0,115],[0,21,105],[0,43,96],
		[0,64,86],[0,85,77],[0,106,67],[0,128,58],[0,149,48],[0,170,38],[0,191,29],[0,213,19],
		[0,234,10],[0,255,0],[26,255,0],[51,255,0],[77,255,0],[102,255,0],[128,255,0],
		[153,255,0],[179,255,0],[204,255,0],[230,255,0],[255,255,0],[255,230,0],[255,204,0],
		[255,179,0],[255,153,0],[255,128,0],[255,102,0],[255,77,0],[255,51,0],[255,26,0],
		[255,0,0],[230,0,0],[204,0,0],[179,0,0],[153,0,0],[128,0,0],[102,0,0],[77,0,0],
		[51,0,0],[26,0,0],[0,0,0],[26,26,26],[51,51,51],[77,77,77],[102,102,102],
		[128,128,128],[153,153,153],[179,179,179],[204,204,204],[230,230,230],[255,127,203],
		[242,114,195],[229,102,188],[217,89,180],[204,76,173],[191,64,165],[178,51,157],
		[165,38,150],[153,25,142],[140,13,135],[127,0,127],[255,255,0],[219,219,0],
		[182,182,0],[146,146,0],[109,109,0],[73,73,0],[36,36,0],[0,0,0],[255,0,0],[255,26,26],
		[255,51,51],[255,77,77],[255,102,102],[255,128,128],[255,153,153],[255,179,179],
		[255,204,204],[255,230,230],[255,255,255]])
	color_flip = np.flipud(color_map)
	colors = color_flip.astype(np.uint8)
	pl_colorscale = [[np.round(s, 2), f'rgb{tuple(color)}'] for s, color in zip(scale, colors)]
# 	image_fig = px.imshow(ds.CMI_C13, color_continuous_scale=pl_colorscale, aspect='equal')
# 	image_fig.update_coloraxes(showscale=False)
# 	image_fig.update_yaxes(autorange='reversed')
